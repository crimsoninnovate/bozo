...
/**
 * Ana sayfanın iddia bölümü. Kaynak UYGULAMA-NOTLARI 5;
    ...
    <Bolum id="iddia" yogunluk={0.55} className={stil.bolum} eritClassName={stil.erit}>
      <div className={stil.sol}>
        ...
        <div className={stil.sayaclar}>
          <SayacHucresi
            deger={<AnimasyonluSayac hedef={Number(sayac1.deger)} />}
            etiket={sayac1.etiket}
          />
          {/* "4+2" bir sayı değil, bir oran; tasarımda da data-sayac taşımaz (Ana:139). */}
          <SayacHucresi deger={sayac2.deger} etiket={sayac2.etiket} />
          <SayacHucresi
            deger={<AnimasyonluSayac hedef={Number(sayac3.deger)} />}
            etiket={sayac3.etiket}
          />
        </div>
      </div>
