...
export function CamPanel({ opaklik, dolgu = 'genis', genislik = 'serbest', className, children }: Props) {
  ...
  const sinif = [stil.panel, zeminSinif, dolguSinif, genislik === 'sayfa' ? stil.sayfaEni : '', className]
    .filter(Boolean)
    .join(' ')
